...
int main() {
    ...
    objs = {
Object(glm::vec3(750, 750, 0), glm::vec3(1000, 0, 1000), 3.3011e21, 5430, glm::vec4(0.7f, 0.7f, 0.7f, 1.0f)),


Object(glm::vec3(-1000, 1000, 0), glm::vec3(-1000, 0, 500), 4.8675e21, 5243, glm::vec4(1.0f, 0.8f, 0.3f, 1.0f)),
...
Object(glm::vec3(4000, -4000, 0), glm::vec3(500, 0, 0), 5.6834e22, 687, glm::vec4(1.0f, 0.95f, 0.6f, 1.0f)),

Object(glm::vec3(-5000, 0, 0), glm::vec3(200, 0, 500), 8.68e22, 1271, glm::vec4(0.5f, 1.0f, 1.0f, 1.0f)),

Object(glm::vec3(-6000, 0, 0), glm::vec3(100, 0, -500), 7.0241e22, 1638, glm::vec4(0.4f, 0.6f, 1.0f, 1.0f)),

Object(glm::vec3(0, 0, 0), glm::vec3(0, 0, 0), 1.989e25, 1408, glm::vec4(1.0f, 0.929f, 0.176f, 1.0f), true),
